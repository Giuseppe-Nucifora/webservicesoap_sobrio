...
class ServizioMonitoraggioCentraline(ServiceBase):
    ...
    def MemorizzaRilevazione(stringaJson):
    ...
    @srpc(str,_returns=str)
    def ConfiguraCentralina(stringaJson):#Restituisce id della centralina
        server = '(localdb)\\MSSQLLocalDB'
        database = 'Dati_Raccolti'
        username = 'sa'
        password = 'abacus'
    ...
    @srpc(str, _returns=str)
    def GetConfCentralina(identificatoreCentralina):
        server = '(localdb)\\MSSQLLocalDB'
        database = 'Dati_Raccolti'
        username = 'sa'
        password = 'abacus'
        ...
        c2 = cnxn.cursor()
        c2.execute("SELECT * FROM Centraline WHERE identificatoreCentralina='A1234BCD1E'")
